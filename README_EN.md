...
| **Toolathlon-Verified** | Multi-tool / MCP-style agent tool-use workflows. | Opus 4.8 **76.2*** · DeepSeek-V4-Flash **70.3*** · GLM-5.2 **59.9*** · Pro Preview **51.8** · Flash Preview **47.8** | [Tool-Decathlon](https://github.com/HKUDS/Tool-Decathlon) · [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **Cybergym** | Cybersecurity / exploit-style agent eval (often co-reported with coding agents). | Opus 4.8 **83.1*** · DeepSeek-V4-Flash **76.7*** · Pro Preview **43.2** · Flash Preview **17.3** · GLM-5.2 n/a | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **AutomationBench (Public)** | End-to-end business-automation agents (Zapier-style). | Opus 4.8 **27.2*** · DeepSeek-V4-Flash **25.1*** · GLM-5.2 **12.9*** · Pro Preview **7.0** · Flash Preview **6.0** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) · (also highlighted in Anthropic Opus 5) |
| **Agents' Last Exam** | Hard general-agent exam suite. | Opus 4.8 **25.7*** · DeepSeek-V4-Flash **25.2*** · GLM-5.2 **23.8*** · Pro Preview **15.7** · Flash Preview **13.1** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **DSBench-FullStack / Hard** | DeepSeek **internal** full-stack / hard coding-agent sets (not a public bench). | FullStack: Opus 4.8 **71.6** · Flash **68.7** · GLM-5.2 **61.8** · Pro Preview **41.8** · Flash Preview **37.0** · Hard: Opus 4.8 **71.7** · Flash **59.6** · GLM-5.2 **54.5** · Pro Preview **31.1** · Flash Preview **25.8** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) (marked internal) |
