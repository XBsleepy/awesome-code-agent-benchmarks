...
| **Toolathlon-Verified** | 多工具 / MCP Agent（108 题）；**2026-06-30 起 Verified 新系列，不可与旧版混比**。 | **官方独立榜 Pass@1**：[toolathlon.xyz](https://toolathlon.xyz/docs/leaderboard) · Kimi K3 max **76.5** · Opus 4.8 max **76.2** · Muse Spark 1.1 **75.6** · GPT-5.5 xhigh **73.5** · Sonnet 5 max **71.6** · Gemini 3.5 Flash **67.3** · Gemini 3.1 Pro **61.1** · GLM-5.2 max **59.9** · V4-Pro max **55.9** · V4-Flash max **50.9** · *另：DeepSeek 0731 自报 Flash **70.3** / Opus 4.8 **76.2**（DeepSeek Harness，≠官方 Default Agent）· Kimi 模型卡另报 Fable 5 **77.9** / GPT-5.6 Sol **74.9*** | [Leaderboard](https://toolathlon.xyz/docs/leaderboard) |
...
| **AutomationBench (Public)** | Zapier 端到端业务自动化（销售/市场/运维等）；**以环境终态断言计分**。 | **Zapier 官方榜**：[zapier.com/benchmarks](https://zapier.com/benchmarks) · Opus 5 Max **26.2%** · Opus 5 XHigh **25.1%** · Gemini 3.6 Flash High **19.8%** · GPT-5.6 Sol Max **18.1%** · Fable 5 Max **17.4%** · Opus 4.8 XHigh **17.2%** · *另：DeepSeek 0731 表 Flash **25.1** / Opus 4.8 **27.2** / GLM **12.9**（口径可能不同，勿与 Zapier 榜直比）· Kimi 卡另报 K3 **30.8** / Sol **29.7*** | [Zapier AutomationBench](https://zapier.com/benchmarks) |
| **Agents' Last Exam** | Berkeley RDI：长程职业工作流 Agent 考（多行业）；分 Near-Term / Full-Spectrum / Last-Exam 等档。 | **OpenAI GPT-5.6 发版表**：[openai.com/index/gpt-5-6](https://openai.com/index/gpt-5-6/) · Sol **52.7%** · Terra **50.4%** · Luna **50.3%** · GPT-5.5 **46.9%** · Opus 4.8 **45.2%** · Fable 5 **40.5%** · Gemini 3.1 Pro **32.1%** · *DeepSeek 0731 表 Flash **25.2** / Opus 4.8 **25.7** / GLM **23.8** 数值量级不同，疑为不同子集/harness，勿混排* | [agents-last-exam.org](https://agents-last-exam.org/) · [论文](https://arxiv.org/abs/2606.05405) · [GPT-5.6](https://openai.com/index/gpt-5-6/) |
| **DSBench-FullStack / Hard** | DeepSeek **内部**全栈 / 难题 Coding Agent 集；目前未见其他厂商独立公开复现。 | 仅 0731 对比表：FullStack Flash **68.7** / Opus 4.8 **71.6** / GLM **61.8** · Hard Flash **59.6** / Opus 4.8 **71.7** / GLM **54.5** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/)（标明内部） |
