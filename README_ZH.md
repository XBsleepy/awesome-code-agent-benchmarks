...
| 名称 | 简介 | 模型与分数 | 榜单链接 |
|------|------|------------|----------|
| **Terminal-Bench 2.1** | 隔离终端中完成多步骤真实任务（写代码、配置、调试、数据处理、ML、安全等）。覆盖厂商最广。 | GPT-5.6 Sol **88.8%**（Sol Ultra 多 Agent **91.9%**, Codex）· Kimi K3 **88.3%** (Kimi Code) · Opus 4.8 **85.0%*** · Grok 4.5 **83.3%** · DeepSeek-V4-Flash **82.7%*** · GLM-5.2 **81.0%** · Gemini 3.6 Flash **78.0%** · Gemini 3.5 Flash **76.2%** · Seed2.1 Pro **71.0%** / Turbo **67.6%** · MiniMax M3 **66.0%** · Flash Preview **63.3** · Pro Preview **67.9** · *Flash/Opus 分见 DeepSeek 0731 对比表；Flash 测自 DeepSeek Harness minimal / max effort* | [tbench.ai/2.1](https://www.tbench.ai/news/terminal-bench-2-1) |
| **DeepSWE v1.1** | 113 个原创长周期 SWE 任务（91 仓 / 5 语言）；人工验证器，降低公开 PR 污染。增长最快的新榜。 | GPT-5.6 Sol **72.7%** · Kimi K3 **67.5%** · Opus 4.8 **59.0%*** · DeepSeek-V4-Flash **54.4%*** · Grok 4.5 **53%** · Gemini 3.6 Flash **49%** · GLM-5.2 **46.2%** · Flash Preview **7.3** · Pro Preview **9.8** · *0731 表自报 DeepSWE（未标 v1.1）* | [Leaderboard](https://deepswe.datacurve.ai/) · [论文](https://arxiv.org/abs/2607.07946) |
...
| **NL2Repo** | 高层需求 → 端到端仓库开发（架构/多文件/交付）。中国厂商更常报。 | Opus 4.8 **69.7*** · DeepSeek-V4-Flash **54.2*** · GLM-5.2 **48.9** · Seed2.1 Pro **47.0** / Turbo **43.7** · Qwen3.7-Max **47.2** *(GLM 引述)* · Flash/Pro Preview **35.5** · *Opus/Flash 见 0731 对比表* | 见文末模型页（榜无统一官网） |
| **Toolathlon-Verified** | 多工具 / MCP 类 Agent 工具调用与工作流。 | Opus 4.8 **76.2*** · DeepSeek-V4-Flash **70.3*** · GLM-5.2 **59.9*** · Pro Preview **51.8** · Flash Preview **47.8** | [Tool-Decathlon](https://github.com/HKUDS/Tool-Decathlon)（社区常用名 Toolathlon）· [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **Cybergym** | 网络安全 / 漏洞利用类 Agent 评测（非纯编程，但常与 coding agent 同表）。 | Opus 4.8 **83.1*** · DeepSeek-V4-Flash **76.7*** · Pro Preview **43.2** · Flash Preview **17.3** · GLM-5.2 未报 | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **AutomationBench (Public)** | 端到端业务自动化 Agent（Zapier 等场景常用）。 | Opus 4.8 **27.2*** · DeepSeek-V4-Flash **25.1*** · GLM-5.2 **12.9*** · Pro Preview **7.0** · Flash Preview **6.0** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) · （Anthropic Opus 5 亦强调该榜） |
| **Agents' Last Exam** | 高难度通用 Agent 综合考试。 | Opus 4.8 **25.7*** · DeepSeek-V4-Flash **25.2*** · GLM-5.2 **23.8*** · Pro Preview **15.7** · Flash Preview **13.1** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/) |
| **DSBench-FullStack / Hard** | DeepSeek **内部**全栈开发 / Coding Agent 难题集（非正式公开榜）。 | FullStack：Opus 4.8 **71.6** · Flash **68.7** · GLM-5.2 **61.8** · Pro Preview **41.8** · Flash Preview **37.0** · Hard：Opus 4.8 **71.7** · Flash **59.6** · GLM-5.2 **54.5** · Pro Preview **31.1** · Flash Preview **25.8** | [DeepSeek changelog](https://api-docs.deepseek.com/updates/)（注明为内部集） |
