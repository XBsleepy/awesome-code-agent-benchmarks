...
窗口：**2026-05-01 → 2026-08-12** · 厂商官方发版/模型卡里仍在报的 Code Agent 榜  
...
| **DeepSWE v1.1** | 113 个原创长周期 SWE 任务（91 仓 / 5 语言）；人工验证器，降低公开 PR 污染。增长最快的新榜。 | GPT-5.6 Sol **72.7%** · Kimi K3 **67.5%** · Grok 4.6 High **65.9%*** · Opus 4.8 **59.0%*** · Qwen3.8-Max **56.6%*** · DeepSeek-V4-Flash **54.4%*** · Grok 4.5 **53%** · Gemini 3.6 Flash **49%** · GLM-5.2 **46.2%** · Flash Preview **7.3** · Pro Preview **9.8** · *Grok 4.6 High / Qwen 为厂商表；Qwen 官方表标为 DeepSWE 1.1；0731 表自报 DeepSWE（未标 v1.1）* | [Leaderboard](https://deepswe.datacurve.ai/) · [论文](https://arxiv.org/abs/2607.07946) |
